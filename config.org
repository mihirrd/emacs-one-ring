...
;; LSP support (use pyright or pylsp)
(use-package lsp-mode
  :ensure t
  :hook (python-mode . lsp)
  :commands lsp
  ...
  (lsp-pylsp-plugins-black-enabled t) ;; Format with Black
  (lsp-pylsp-plugins-mccabe-enabled nil)
  (lsp-pylsp-plugins-pycodestyle-enabled nil)
  (lsp-enable-on-type-formatting nil)
  (lsp-prefer-flymake nil))

;; LSP UI for in-buffer help, docs, etc.
(use-package lsp-ui
  :ensure t
...
;; Black for autoformatting (optional if not using lsp-based formatting)
(use-package blacken
  :ensure t
...
(use-package pyvenv
  ...
  :config
  (setq pyvenv-workon "your-venv-name") ;; optional, if using virtualenvwrapper
